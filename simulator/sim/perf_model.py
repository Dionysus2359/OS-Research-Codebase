...
class PerfModel:
  ...
  def compute_other_metrics(self):
    ...
    self.stats['Num_Pages_Misplaced'] = len(self.profile.scheduler.unique_misplaced_pages)
    self.stats['Total_Misplaced_Epochs'] = self.profile.scheduler.total_misplaced_epochs
