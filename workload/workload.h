...
constexpr int FAST_LATENCY_NS = 86;        // Measured local DRAM on r650
constexpr int SLOW_LATENCY_NS = 145;       // Measured remote DRAM on r650
constexpr int SLOW_WRITE_LATENCY_NS = 185; // Measured remote write on r650
